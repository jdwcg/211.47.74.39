...
<body>
    ...
    <div class="containerWrapperHeader" id="containerWrapperHeader">
        <div class="container header">
            <div class="logo"><a href="index.php"><img src="<?php echo G5_URL ?>/ackr-imgs/ackr-logo-m.svg" alt="로고"></a></div>
            <ul>
                <li class="gnb">
                    <a href="#">연구개요</a>
                    <ul>
...
<!-- 모듈화 -->
    <header id="header-m">
        <div class="headerBar">
            ...
            <div class="logo-m"><a href="index.php"><img src="<?php echo G5_URL ?>/ackr-imgs/ackr-logo-m.svg" alt="로고"></a></div>
            ...
            <div class="nav">
                <ul>
                   <style media="screen">
                    ...
                    <li class="gnb-m">
                        <a href="sub_f2.php">회원가입</i></a>
                    </li>
                    <li class="gnb-m">
                        <a href="sub_f3.php">로그인</i></a>
                    </li>
                </ul>
            </div>
        </div>
