...
<body>
    <div class="containerWrapperTnb">
        <div class="container tnb">
            <div class="col">
                <a href="<?php echo G5_URL ?>/index_eng.php"><i class="bi bi-globe2"></i> KR</a>
                <a href="sub_sitemap.php">Site Map</a>
            </div>
            <div class="col">
                <?php if ($is_member) {  ?>
    ...
    <div class="containerWrapperHeader" id="containerWrapperHeader">
        <div class="container header">
            <div class="logo"><a href="<?php echo G5_URL ?>/index_eng.php"><img src="<?php echo G5_URL ?>/ackr-imgs/ackr-logo-m.svg" alt="logo"></a></div>
            <ul>
                <li class="gnb">
                    <a href="#">About Us</a>
                    <ul>
            ...
            <div class="nav">
                <ul>
                   <style media="screen">
                    ...
                    <li class="gnb-m">
                        <a href="#">About Us<i class="bi bi-chevron-compact-down"></i></a>
                        <ul>
                        <li><a href="<?php echo G5_URL ?>/sub_a2_eng.php?id=vision">Vision</a></li>
                        <li><a href="<?php echo G5_URL ?>/sub_a3_eng.php?id=prj">Intro</a></li>
                        <li><a href="<?php echo G5_URL ?>/sub_a4_eng.php?id=organization">Organization</a></li>
                    ...
                    <li class="gnb-m">
                        <a href="<?php echo G5_URL ?>/sub_sitemap_eng.php">Site Map</i></a>
                    </li>
                    <!-- <li class="gnb-m">
