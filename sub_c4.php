        ...
        <div class="container section01">
            <div class="row">
                <div class="col subMenuList">
                    <ul>
                        <li></li>
                        <li><a href="sub_c1.php">연구계획<span><i class="bi bi-chevron-compact-right"></i></span></a></li>
                        <li><a href="sub_c2.php">강의안내<span><i class="bi bi-chevron-compact-right"></i></span></a></li>
                        <li><a href="sub_c3.php">연구활동<span><i class="bi bi-chevron-compact-right"></i></span></a></li>
                        <li><a href="sub_c4.php">학술행사<span><i class="bi bi-chevron-compact-right"></i></span></a></li>
                        <li></li>
                    </ul>
                </div>
                <div class="col subArticle">
                    <article id="article">
                        <div id="line" class="c4_all">
                            <h1>학술행사</h1>
                            <div class="main">
                              <section class="first">
                                <figure>
                                ...
                                <div class="box1">
                                  ...
                                  <h3 style="word-break: break-all;">k종교 연구의 국내외 경향을 검토하고, 본연구계획서에서
                              ...
                              <section class="second">
                                ...
                                <div class="sec_all">
                                  <div class="box2">
                                    <h2>국문연구서</h2>
                                    <h3 style="word-break: break-all;">국문연구서의 내용은 강의에서 가장 중심을 이루는 종교적 문물과 의례를 다룬다. 집필 방향은
                                  ...
                                  <div class="box3">
                                    <h2>영문연구</h2>
                                    <h3 style="word-break: break-all;">K종교문화 및 국내의 종교연구 성과를 국제적으로 확산하는데 목표를둔다.
                                  ...
                                  <div class="box4">
                                    <h2>백서</h2>
                                    <h3 style="word-break: break-all;">백서는 3차연도에 발간한다. 백서는 설립할 K학술확산연구소의 시작과 더불어 모든 활동을 기록한다.
                              ...
                              <section class="third">
                                ...
                                <div class="box5">
                                  <h2>K-종교 다큐멘터리</h2>
                                  <h3 style="word-break: break-all;">다큐멘터리는 본 연구의 독창적인 기획이다.
