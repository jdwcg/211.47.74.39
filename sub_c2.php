        ...
        <div class="container section01">
            <div class="row">
                ...
                <div class="col subArticle">
                    <article id="c2_Article">
                        <div id="line" class="c2_all">
                            <h1>강의안내</h1>
                            <div class="main">
                              <article class="first">
                                <figure>
                                ...
                                <section class="box1">
                                  <h2>강의 개요</h2>
                                  <h3 style="word-break: break-all;">각 광자는 총 10개로 구성되며, 각 강의는 12분짜리 동영상 6개로 세분화한다.
                              ...
                              <article class="second">
                                ...
                                <div class="sec_all">
                                  <section class="box2">
                                    <h2>범용성-권역 맞춤 특성화</h2>
                                    <h3 style="word-break: break-all;">본 연구소는 역점을 두는 지역을 유럽과 아메리카 지역에 역점을 두고자 한다.
                                  ...
                                  <section class="box3">
                                    <h2>권역의 특징</h2>
                                    <h3 style="word-break: break-all;">전체 강좌는 한국에서 현재 진행하는 종교의 소개 중심이다.
                                  ...
                                  <section class="box4">
                                    <h2>강의 커리큘럼</h2>
                                    <h3 style="word-break: break-all;">K종교 강의는 모두 문화와 예술을 아우르는 융복합 연구이며, 현재 한국종교에서 행하는 구체적 실천과
